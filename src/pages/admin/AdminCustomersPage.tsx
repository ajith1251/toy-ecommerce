  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {error ? (
        ...
        <p className="text-slate-500 dark:text-slate-400 py-12 text-center">No customers match these filters.</p>
      ) : (
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {customers.map(customer => (
                <tr key={customer.id} className="border-b border-slate-50 dark:border-slate-800/50 last:border-0">
